...
parser = argparse.ArgumentParser(description='Search for stretches with a certain number of arginines or lysines.', usage='[options]')
...
parser.add_argument('-L', '--length', type=int, default=10, help='length of the stretch')
...
def main():
	...
	header_basic = 'Search for stretches with a certain number of arginines or lysines\n'
	...
	header_data = 'name;position (in nucleotides);relative position;number'
